...
static const u8* confuzz_before[] = {
"\tcall\tfree\n",
"\tcall\t_Znwm\n",
"\tcall\t_ZdlPv\n",
"\tcall\tmalloc\n",
...
static const u8* confuzz_trampoline =
  "\n"
  "/* --- AFL CON --- */\n"
  "\n"
  ".align 4\n"
  ...
  "movq %%rsi, 48(%%rsp)\n"
  "movq $0x%08x, %%rcx\n"
  "call __confuzz_before_priority\n"
  "movq 48(%%rsp), %%rsi\n"
  "movq 40(%%rsp), %%rdi\n"
  "movq 32(%%rsp), %%rbp\n"
  "movq 24(%%rsp), %%rbx\n"
...
static const u8* confuzz_main_64 = 
  "\n"
  "/* --- CONFUZZ (64-BIT) --- */\n"
  "\n"
  ".text\n"
  ...
  ".align 8\n"
  "\n"
  "__confuzz_before_priority:\n"
  "\n"
  "  lahf\n"
  "  seto  %al\n"
  "\n"
  "  /*检查confuzz bitmap是否已初始化*/\n"
  "\n"
...
//  "  andq  $0xfffffffffffffff0, %rsp\n"
  ...
  "\n"
  "  movq  __afl_con_global_area_ptr@GOTPCREL(%rip), %rdx\n"
  "  movq  (%rdx), %rdx\n"
  "  testq %rdx, %rdx\n"
  ...
  "  .comm    __afl_con_global_area_ptr, 8, 8\n"
  "\n"
  ".CON_SHM_ENV:\n"
  "  .asciz \"" CONFUZZ_ENV_VAR "\"\n"
  "\n"
  "/* --- END --- */\n"
  "\n";
